...
<ul>
  <li>Ask Cadence, or any character with the studio tool, for a <strong>narration</strong>. It is a queued job, not instant: your phone buzzes when it is ready and the clip lands in <strong>My Creations</strong>. A cold start can add about seven minutes; if no graphics card is free, the queue can be longer. The progress line explains the wait.</li>
