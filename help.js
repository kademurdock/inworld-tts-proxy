...
<p>For speech, describe the voice's accent, texture, mood and delivery, then write the exact words in the performance script. Bracketed directions between lines steer the acting. Import a clean voice sample to anchor a particular voice. The voice wheel supplies a description; it does not make an exact copy of the wheel's original voice.</p>
...
<p>On the website, Render opens a focused <strong>Confirm paid generation</strong> window. Its cost information is attached to the <strong>Start paid generation</strong> button for screen readers. Choose that button to proceed, or <strong>Keep editing</strong> to spend nothing. Escape also closes the confirmation without starting work.</p>
