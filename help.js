...
<p>On the website and iPhone build 300 or later, start in the main writing box. <strong>Write a script from this</strong> turns your idea into editable text using the writing model. For music, the button shapes your music idea; YuE2 can draft the lyrics too. <strong>Surprise me</strong> gives you a starting idea: for songs the writer brainstorms a batch of concepts, throws away the familiar ones and gives you the best, which takes about twenty seconds and costs a fraction of a cent, and for speech and scenes it rolls a free one on the page. If the writer cannot be reached, you get a free idea from the short list instead; <strong>Undo writing change</strong> restores what was there. None of these buttons starts an audio recording. Voice, references and detailed settings remain in expandable sections. The separate writing desk still offers exact-word formatting.</p>
