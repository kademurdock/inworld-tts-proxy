...
<p>Choose <strong>Stable Audio</strong> in the <a href="/sound-booth">Sound Booth</a> for environmental sound, foley and layered ambience. This uses the finished Stable Audio 3 Small SFX model through fal. Describe the foreground sound, quieter background layers and the space around them. Try the rain-cabin, harbor or forest-stream starting points. Ask for no music or speech when you want only environmental sound. Complex layers are not guaranteed; this produces one mixed recording, not separate stems.</p>
<p>Enter an optional <strong>Track title</strong>, choose <strong>1 to 120 seconds</strong> and <strong>1 to 4 takes</strong>, then press <strong>Generate sounds</strong> once. Each take uses a different seed. All takes are submitted together; fal controls how many run at once. Provider cost is <strong>2.06 cents per recording</strong>, or <strong>8.24 cents for four</strong>, verified September 18, 2026. During this trial, Kade pays that cost and nothing is deducted from your credit balance. The price appears before you generate; there is no additional confirmation screen.</p>
...
<p><strong>Inference steps</strong> default to 8 for this distilled model; increasing them takes longer and does not guarantee better sound. An optional seed lets you reuse a starting point. This SFX engine does not offer voice cloning, cover-song controls or a guidance slider. Seed Audio remains available for scenes with dialogue.</p>
...
<p><strong>Sound Booth lyric drafts now follow Lyric:</strong> the music writing desk reads the Lyric agent's current saved persona for each new draft. Its craft guidance covers connected thoughts, believable voices, internal and multisyllabic rhyme when appropriate, and a private edit for forced rhymes and stock phrasing. The desk now uses Grok 4.20 with the same creative settings as Lyric, while keeping the Sound Booth output format. Existing lyrics supplied to the desk stay unchanged. To replace a draft you dislike, clear the Lyrics box before choosing Write my song idea. Drafting new lyrics does not generate a recording. Prompt guidance improves the target, but cannot guarantee every line will land.</p>
