...
<h2>Donate from a Windows computer</h2><p><a href="/help/library-uploader-download">Download Kade Library Uploader for Windows (EXE, 17 MB)</a> · <a href="/help/library-uploader-zip">Download the app and guide together (ZIP, 17 MB)</a></p><p>Version 1.1 for Windows 10 or 11, 64-bit. Audiobook MP3/M4B and DAISY ZIPs can be up to 4 GB; text-book files remain limited to 256 MB. Uploads stream from disk. If a book upload is interrupted or its receipt is lost, check Your library before retrying. Finish or pause current uploads and close the older uploader before opening this version; your saved queue is retained. Open the EXE and sign in with your own platform account. Choose Donate for review or Keep private, add files or a folder, check Edit details, then choose Start / resume. It keeps Books, Audio, and Videos separate and lets you organize your own uploaded items. Ordinary-member donations remain private until reviewed; an administrator can publish directly.</p>
