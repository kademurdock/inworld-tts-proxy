...
<p>The rented GPU sleeps between jobs. Startup, processing and brief idle time are billable; availability and cold starts can delay a job. Progress and Stop remain available. If the connection drops, reopen the existing project before starting another take. Stopping or failure does not prove that no GPU time was charged. Check the spoken estimate before confirming; it is an estimate, not a flat per-minute price.</p>
