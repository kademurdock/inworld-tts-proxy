...
<ul class="cards" id="hubcards">
  ...
  <li data-terms="games game parlor cards blackjack wild eights go fish dealer play deal poker dice trivia casino pig phone sounds quiz leaderboard game room standings wins champion"><a href="/help/games"><span class="ico" aria-hidden="true">🃏</span><span class="ttl">The Game Parlor</span><span class="desc">Play real games by voice — Blackjack, Wild Eights, Go Fish, Pig dice, Trivia Night. Real table sounds, and a family leaderboard in the Game Room.</span></a></li>
