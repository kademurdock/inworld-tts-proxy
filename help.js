...
<p>On the website and Android 2.11 (build 112), Kiana and Della have their own prepared eyes, mouths and brow expressions, with graduated movement following playback and individual movement rhythms. Della has silver curls and a plum cardigan. TestFlight 280 still has Kiana&rsquo;s earlier facial animation, with Della&rsquo;s own still portrait. The richer iPhone animation and call portraits are in the next release candidate. Other characters use their own portrait with gentle movement while individual facial artwork is prepared. An unavailable or changed portrait falls back safely. Animation does not change the voice and adds no speech-generation request. Playing an older text reply can still generate speech at the normal voice cost.</p>
