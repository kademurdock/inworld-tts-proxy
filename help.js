...
<p>To make a <strong>YuE2 cover</strong>, import a source recording in song settings, describe the new style, and add the words to sing in Lyrics. Or choose <strong>Cover this take</strong> on a saved Lyria or YuE2 song. The original stays in your library. Recordings can be WAV, MP3, M4A or OGG, up to twenty megabytes and six minutes. The worker transcribes the melody and then makes a new arrangement on the same GPU. Melody transcription can make mistakes and does not clone the singer. After importing, choose <strong>Transcribe reference lyrics</strong> to try the separate transcription service for an editable draft of the sung words. Correct wrong or missing words in Lyrics and add verse or chorus tags as needed. <strong>Undo writing change</strong> restores the previous lyrics. This button does not generate music or deduct credits; existing completed transcripts are reused. You can also supply an ABC melody score instead of a recording. Voice cloning, LoRAs and saved singer personas are not offered by this integration. A take that reaches a model limit is marked as possibly ending early. The website also offers a composition-score download.</p>
