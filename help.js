...
<p>A draft usually costs <strong>a few cents</strong> of credit from the same allowance everything else uses. Longer revisions can cost more. The writer uses Hermes 4 405B and reports the provider's cost when available; otherwise the amount is a token-based estimate.</p>
...
<p>These writing desks use <strong>Hermes 4 405B</strong>, Nous Research's uncensored, user-directed model. This choice applies to the text writer; AuK, Seed Audio and Lyria still make the recordings with their own capabilities and provider rules. Your existing drafts are not automatically rewritten.</p>
...
<li>Read or listen to the cost information, then confirm. The result is a new take; your source and previous takes remain available.</li>
</ol>
...
<p>On the website and iPhone build299, Render opens <strong>Confirm paid generation</strong> with the cost information. The web version attaches that information to the focused <strong>Start paid generation</strong> button for screen readers. Choose that button to proceed, or <strong>Keep editing</strong> to spend nothing. Escape also closes the web confirmation without starting work.</p>
