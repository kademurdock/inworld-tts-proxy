...
<ul>
  <li><strong>The iPhone voice picker is wheels now (build 263 in TestFlight), Kade's own design.</strong> Pick <strong>who</strong> first (Women, Men, Kids and teens, Characters), then spin a wheel for the <strong>kind</strong> of voice (bright and high, seasoned and gravelly, Southern, from abroad&hellip;), then spin the <strong>voice</strong> wheel &mdash; and every voice you land on says a quick hello as you flick past. Hit Done and that is your voice; Cancel leaves it alone. "Use the character's own voice" is a switch at the top. The full audition is on a button and on the rotor, the search box still finds voices by words like <em>husky</em> or <em>British</em>, and an old pick like "Voice 69" opens the wheels on the label it became. Labels read "smooth grown man, cleat" now instead of "dot".</li>
