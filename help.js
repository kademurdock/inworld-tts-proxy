...
<p>On the website and Android 2.10 (build 111), Kiana and Della have their own prepared eyes and mouths, with graduated movement following playback. Della has silver curls and a plum cardigan. TestFlight 280 still has Kiana&rsquo;s earlier facial animation, with Della&rsquo;s own still portrait. The richer iPhone animation is prepared for a later build. Other characters use their own portrait with gentle movement while individual facial artwork is prepared. An unavailable or changed portrait falls back safely. Animation does not change the voice and adds no speech-generation request. Playing an older text reply can still generate speech at the normal voice cost.</p>
...
PAGES.android = {
  ...
  main: `
<h2>Android 2.10 (build 111): Della and smoother voice portraits</h2>
<p>Voice-message playback now shows the original character&rsquo;s portrait. Kiana and Della have their own prepared eye and mouth movements, with graduated opening and closing; other characters keep their own picture with gentle movement. Pause and Resume keep the current audio. Unknown audio formats keep a closed mouth while the voice continues.</p>
