...
<ul>
  <li><strong>Memory grew up.</strong> Companions used to haul every memory card into every message. Now the essentials stay always-on &mdash; who you are, your people, your reminders &mdash; and everything else comes to mind <em>when it's relevant</em>, like a real friend's memory. Ask Kiana "what do you actually remember about my family?" and she'll tell you, warmly and completely. (Kiana first; everyone else soon.)</li>
  <li><strong>The memory also tidied itself up.</strong> A one-time housekeeping pass went through everyone's cards: duplicates merged, notes that clearly belong together got introduced to each other, and stiff old phrasing got rewritten the way a friend would say it. Every single change is on a trail &mdash; ask any companion <em>"what changed in your memory lately?"</em> and hear exactly what moved, nothing hidden, nothing lost.</li>
</ul>
