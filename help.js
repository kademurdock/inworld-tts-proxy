...
<ul>
  ...
  <li><strong>Kade Keys types your real prompts now.</strong> The new keyboard's second act: flip on <em>Allow Full Access</em> for Kade Keys in Settings, open the Prompts tile in the app once, and your first dozen saved prompts ride the keyboard as big spoken buttons &mdash; in Messages, Mail, anywhere &mdash; fully offline. Plain words about that switch: Apple gates shared storage behind the same permission as network access, so the warning sounds broad, but this keyboard makes no connections at all. Leave the switch off and the six built-in phrases stay right where they were.</li>
