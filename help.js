...
<ul>
  ...
  <li><strong>And if you like choosing, the brain button grew options.</strong> On the newest app update it cycles three ways: <em>Automatic</em> (they decide), <em>Deep</em> (always take your time), <em>Instant</em> (always the fast answer). Better yet — when a character is off thinking hard and you're in a hurry, a new <em>Answer now instead</em> button appears right under their thinking bubble. Tap it and get the quick version of the same answer.</li>
